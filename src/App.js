...
export default function App() {
  ...
  return (
    <div>
      ...
      <div className="col-2">
        {/* render is instructions (always a function) on how to render something when it is passed as a prop*/}
        <List
          title="Products"
          items={products}
          render={(product) => (
...
// LATER: Let's say we got this component from a 3rd-party library, and can't change it. But we still want to add the 2 toggle functionalities to it (to collapse the list in the UI).
